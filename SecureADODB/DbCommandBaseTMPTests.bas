...
' These test cases were removed from the DefaultDbCommandModule along with Guards
' present DbCommandBase. These tests should be adapted for the DbCommandBase module.
'
